...
public class TuitionGuiController {
	...
	@FXML
	void cTuition(ActionEvent Event)
	{
	    txtOutputArea.setText(calculateTuition());
	}
	@FXML
	void pbName(ActionEvent Event)
	{
	    txtOutputArea.setText(printRosterBN());
	}
	@FXML
    void pbDate(ActionEvent Event)
    {
        txtOutputArea.setText(printRosterBPD());
    }
	@FXML
    void pbCurrentOrder(ActionEvent Event)
    {
        txtOutputArea.setText(printRoster());
    }
	/**
